# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 11:02:23 2024
...
savepath = os.path.join(odPath, "Work\\stack_paper\\figs\\v3")
#%%
datPath = "food_v0"
spath = os.path.join(odPath, "Work\\stack_paper\\dat")
bpath = "results\\gbr"
# bpath = os.path.join(odPath, "Work\\stack_paper\\results\\mod_ls")

grouping = "group_name_v5"
...
colours_stim = { 'Ruminant meat'             : "#40004b",
                ...
                'Tropical fruit'                     : "#a6dba0",
                'Temperate fruit'                     : "#a6dba1",
                'Tropical nuts'                     : "#a6dba2",
                'Temperate nuts'                     : "#a6dba3",
                'Bananas' : "#a6dba3",
                
                'Legumes and pulses'  : "#d9f0d3",
...
bh = bh[~(bh.Item.str.contains("Vanilla"))]
...
for g, group in enumerate(groups):
    ...
    ax.barh(g, -dom_feed, fill = False, linewidth = 0, 
            alpha = alpha, hatch = "//")
    # ratio = offshore_imp / domestic_imp
    # err = ratio * np.sqrt(offshore_imp_err**2+domestic_imp_err**2) / (offshore_imp + domestic_imp)
    # ax.barh(g, ratio, color = colour, 
    #         alpha = alpha, xerr = err)
